...
package com.google.vertcoin.protocols.channels;

import com.google.vertcoin.core.InsufficientMoneyException;
...
public interface IPaymentChannelClient {
     ...
     * {@link PaymentChannelClient.ClientConnection#destroyConnection(com.google.vertcoin.protocols.channels.PaymentChannelCloseException.CloseReason)} or
     ...
     * {@link PaymentChannelClient.ClientConnection#destroyConnection(com.google.vertcoin.protocols.channels.PaymentChannelCloseException.CloseReason)}
     ...
     * be accepted by the vertcoin network. ValueOutOfRangeException will be thrown, however, if there's not enough money
    ...
    interface ClientConnection {
         ...
         * {@link com.google.vertcoin.protocols.channels.PaymentChannelClient#connectionClosed()} should be called immediately. In the case of messages which
         ...
         *
         * <p>Called while holding a lock on the {@link com.google.vertcoin.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         */
         ...
         * {@link com.google.vertcoin.protocols.channels.PaymentChannelClient#connectionClosed()} event should be generated immediately after this call.</p>
         *
         * <p>Called while holding a lock on the {@link com.google.vertcoin.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         *
         ...
         *               {@link com.google.vertcoin.protocols.channels.PaymentChannelCloseException.CloseReason#CLIENT_REQUESTED_CLOSE} as "unrecoverable error" and all others as
         ...
         * {@link com.google.vertcoin.protocols.channels.PaymentChannelClient#incrementPayment(java.math.BigInteger)}
         * may be called at will.</p>
         *
         * <p>Called while holding a lock on the {@link com.google.vertcoin.protocols.channels.PaymentChannelClient}
