...
import com.google.vertcoin.store.BlockStore;
import com.google.vertcoin.store.BlockStoreException;
 ...
 * {@link com.google.vertcoin.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.google.vertcoin.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
    ...
    private static class GetDataRequest {
        ...
        // a nasty hack that relies on the fact that vertcoin-qt is single threaded and processes messages in order.
     ...
     * {@link com.google.vertcoin.net.NioClientManager#openConnection(java.net.SocketAddress, com.google.bitcoin.net.StreamParser)}
     * or
     * {@link com.google.vertcoin.net.NioClient#NioClient(java.net.SocketAddress, com.google.bitcoin.net.StreamParser, int)}.</p>
     *
     ...
     * Once the pong is received the value returned by {@link com.google.vertcoin.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.vertcoin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.vertcoin.core.Peer#ping()} has never
