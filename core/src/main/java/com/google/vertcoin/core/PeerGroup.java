...
import com.google.vertcoin.net.ClientConnectionManager;
import com.google.vertcoin.net.NioClientManager;
import com.google.vertcoin.net.discovery.PeerDiscovery;
import com.google.vertcoin.net.discovery.PeerDiscoveryException;
import com.google.vertcoin.script.Script;
import com.google.vertcoin.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
     ...
     *         Use {@link com.google.vertcoin.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.google.vertcoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.vertcoin.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.google.vertcoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.google.vertcoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.vertcoin.core.Peer#ping()}.
     */
