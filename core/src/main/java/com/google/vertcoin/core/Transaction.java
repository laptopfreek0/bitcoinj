...
public class Transaction extends ChildMessage implements Serializable {
    ...
    // These are serialized in both vertcoin and java serialization.
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.google.vertcoin.script.Script, ECKey, com.google.vertcoin.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.google.vertcoin.core.Transaction.SigHash, boolean)}
    ...
    public synchronized Sha256Hash hashForSignature(int inputIndex, byte[] connectedScript, byte sigHashType) {
        ...
        //
        //   https://en.vertcoin.it/wiki/Contracts
