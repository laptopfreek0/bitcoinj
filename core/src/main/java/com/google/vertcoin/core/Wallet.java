...
package com.google.vertcoin.core;

import com.google.vertcoin.core.TransactionConfidence.ConfidenceType;
import com.google.vertcoin.crypto.KeyCrypter;
import com.google.vertcoin.crypto.KeyCrypterException;
import com.google.vertcoin.crypto.KeyCrypterScrypt;
import com.google.vertcoin.script.Script;
import com.google.vertcoin.script.ScriptBuilder;
import com.google.vertcoin.script.ScriptChunk;
import com.google.vertcoin.store.UnreadableWalletException;
import com.google.vertcoin.store.WalletProtobufSerializer;
import com.google.vertcoin.utils.ListenerRegistration;
import com.google.vertcoin.utils.Threading;
import com.google.vertcoin.wallet.*;
import com.google.vertcoin.wallet.WalletTransaction.Pool;
...
import static com.google.vertcoin.core.Utils.bitcoinValueToFriendlyString;
import static com.google.vertcoin.core.Utils.bitcoinValueToPlainString;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.vertcoin.wallet.WalletFiles.Listener)}
...
public class Wallet implements Serializable, BlockChainListener, PeerFilterProvider {
    ...
    public void receivePending(Transaction tx, @Nullable List<Transaction> dependencies, boolean overrideIsRelevant) throws VerificationException {
        ...
        try {
            ...
            if (log.isInfoEnabled()) {
                log.info(String.format("Received a pending transaction %s that spends %s VTC from our own wallet," +
                        " and sends us %s VTC", tx.getHashAsString(), Utils.bitcoinValueToFriendlyString(valueSentFromMe),
    ...
    private void receive(Transaction tx, StoredBlock block, BlockChain.NewBlockType blockType,
        ...
        log.info("Received tx{} for {} VTC: {} [{}] in block {}", sideChain ? " on a side chain" : "",
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.google.vertcoin.core.Wallet#getBalance()} - the fees required
         ...
         *
         * <p>Once {@link Wallet#completeTx(com.google.vertcoin.core.Wallet.SendRequest)} is called, this is set to the
        ...
        /**
         * If not null, the {@link com.google.vertcoin.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
    ...
    public void completeTx(SendRequest req) throws InsufficientMoneyException {
        ...
        try {
            ...
            // We need to know if we need to add an additional fee because one of our values are smaller than 0.001 VTC
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.vertcoin.wallet.WalletFiles.Listener)}
    ...
    public String toString(boolean includePrivateKeys, boolean includeTransactions, boolean includeExtensions,
        ...
        try {
            ...
            builder.append(String.format("Wallet containing %s VTC (%d satoshis) in:%n",
     ...
     * of {@link com.google.vertcoin.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.google.vertcoin.crypto.KeyCrypter,
     ...
     * {@link com.google.vertcoin.crypto.KeyCrypterScrypt}.
     *
        ...
        try {
            ...
            for (ECKey key : keychain) {
                if (key.isEncrypted()) {
                    ...
                    // (all vertcoin controlled by that private key is lost forever).
    ...
    /**
     * <p>Convenience wrapper around {@link Wallet#addNewEncryptedKey(com.google.vertcoin.crypto.KeyCrypter,
     ...
     * you can use {@link com.google.vertcoin.utils.Threading#waitForUserCode()} to block until the future had a
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.google.vertcoin.core.TransactionBroadcaster broadcaster) {
