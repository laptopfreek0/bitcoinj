...
public abstract class Message implements Serializable {
    ...
    /**
     * Serialize this message to a byte array that conforms to the vertcoin wire protocol.
     * <br/>
    ...
    /**
     * Serialize this message to the provided OutputStream using the vertcoin wire format.
     *
     * @param stream
     * @throws IOException
     */
